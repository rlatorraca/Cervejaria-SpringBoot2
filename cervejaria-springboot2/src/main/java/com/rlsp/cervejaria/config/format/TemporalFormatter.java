...
public abstract class TemporalFormatter<T extends Temporal> implements Formatter<T> {
	...
	public abstract String pattern(Locale locale); // Implementado pelas classe filhas
	
	public abstract T parse(String text, DateTimeFormatter formatter); // Implementado pelas classe filhas
}
